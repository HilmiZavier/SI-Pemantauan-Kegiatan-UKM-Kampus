...
<div class="page-header">
    <h1 class="page-title">Dashboard Admin Kemahasiswaan</h1>
    <p class="page-subtitle">Selamat datang kembali! Berikut statistik global pemantauan kegiatan UKM.</p>
</div>
...
<!-- Status Approval/Verification Ringkas -->
<div class="row g-4 mb-5">
    <!-- Proposal Verification Status -->
    <div class="col-md-6">
        <div class="card-premium h-100">
            <div class="card-premium-header">
                <h5 class="fw-bold m-0"><i class="bi bi-file-text me-2 text-primary"></i>Persetujuan Proposal (Kemahasiswaan)</h5>
            </div>
    ...
    <!-- LPJ Verification Status -->
    <div class="col-md-6">
        <div class="card-premium h-100">
            <div class="card-premium-header">
                <h5 class="fw-bold m-0"><i class="bi bi-file-check me-2 text-success"></i>Persetujuan LPJ (Kemahasiswaan)</h5>
            </div>
            <div class="card-premium-body">
                <div class="row text-center g-3">
                    <div class="col-4">
...
<!-- Row Ketiga: Data Pengajuan & Kegiatan Terbaru -->
<div class="row g-4">
    <!-- Proposal Diajukan Terbaru -->
    <div class="col-lg-6">
        <div class="card-premium h-100">
            <div class="card-premium-header">
                <h5 class="fw-bold m-0">Pengajuan Proposal Terbaru</h5>
                    ...
                    <table class="table-premium">
                        ...
                        <tbody>
                            <?php if (empty($proposal_terbaru)): ?>
                                <tr>
                                    <td colspan="3" class="text-center text-muted py-4">Belum ada pengajuan proposal.</td>
                                </tr>
                            <?php else: ?>
    ...
    <div class="col-lg-6">
        <div class="card-premium h-100">
            <div class="card-premium-header">
                <h5 class="fw-bold m-0">Laporan LPJ Terbaru</h5>
                    ...
                    <table class="table-premium">
                        ...
                        <tbody>
                            <?php if (empty($lpj_terbaru)): ?>
                                <tr>
                                    <td colspan="3" class="text-center text-muted py-4">Belum ada pengajuan LPJ.</td>
                                </tr>
                            <?php else: ?>
